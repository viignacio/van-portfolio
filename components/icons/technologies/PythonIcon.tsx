...
export const PythonIcon: React.FC<PythonIconProps> = ({ className = "w-5 h-5" }) => {
  return (
    <svg width="800px" height="800px" viewBox="0 0 32 32" fill="none" className={className} xmlns="http://www.w3.org/2000/svg">
      <g transform="translate(16, 16) scale(0.875) translate(-16, -16)">
