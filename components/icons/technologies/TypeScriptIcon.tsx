...
export const TypeScriptIcon: React.FC<TypeScriptIconProps> = ({ className = "w-5 h-5" }) => {
  return (
    <svg width="800px" height="800px" viewBox="0 0 32 32" className={className} xmlns="http://www.w3.org/2000/svg">
